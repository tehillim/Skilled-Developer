...
AI 코딩 에이전트(Claude)를 유능한 개발자로 만들기 위해 무엇이 필요한지 정리한 저장소입니다.

A repository on what it takes to make an AI coding agent (Claude) work like a skilled developer. English docs are available under [`docs/en/`](docs/en/).
